...
def main() :
    ...
    try:
        ...
        print("vmPath",vmPath)
        print("---------------------------------------------------------------------")
        print("VM Datastore",vmDSlocation)
        print("---------------------------------------------------------------------")
        print("vmGuest",vmGuest)
        print("---------------------------------------------------------------------")
        print("vmInstanceUUID" , vmInstanceUUID)
        print("---------------------------------------------------------------------")
        print("vmBioUUID",vmBioUUID)
        print("---------------------------------------------------------------------")
        print("vmState", vmState)
        print("---------------------------------------------------------------------")
        print("vmIP" , vmIP)
        print("---------------------------------------------------------------------")
        print("VMwareTools",VMwareTools)
        print("---------------------------------------------------------------------")

        print("vmGuest1",vmGuest1)
        print("---------------------------------------------------------------------")
        print("vmNumCPU",vmNumCPU)
        print("---------------------------------------------------------------------")
        print("vmMemory",vmMemory)
        print("---------------------------------------------------------------------")


        print("vmStatus",vmStatus)
        print("---------------------------------------------------------------------")
        print("vmState",vmState)
        print("---------------------------------------------------------------------")

        print("vmCPUready",vmCPUready)
        print("---------------------------------------------------------------------")
        print("vmCPUusage",vmCPUusage)
        print("---------------------------------------------------------------------")
        print("vmMEMactive",vmMEMactive)
        print("---------------------------------------------------------------------")
        print("vmMEMshared",vmMEMshared)
        print("---------------------------------------------------------------------")
        print("vmMEMballoon",vmMEMballoon)
        print("---------------------------------------------------------------------")

        print("vmDS_readIO",vmDS_readIO)
        print("---------------------------------------------------------------------")
        print("vmDS_writeIO",vmDS_writeIO)
        print("---------------------------------------------------------------------")
        print("vmDS_finalIO",vmDS_finalIO)
        print("---------------------------------------------------------------------")


        print("vmDS_readLatency",vmDS_readLatency)
        print("---------------------------------------------------------------------")
        print("vmDS_writeLatency",vmDS_writeLatency)
        print("---------------------------------------------------------------------")
        print("vmDS_totalLatency",vmDS_totalLatency)
        print("---------------------------------------------------------------------")


        print("vm_NetUsageRx",vm_NetUsageRx)
        print("---------------------------------------------------------------------")
        print("vm_NetUsageTx",vm_NetUsageTx)
        print("---------------------------------------------------------------------")
        print("vm_NetUsageTotal",vm_NetUsageTotal)
        print("---------------------------------------------------------------------")
        '''
